  ...
  <main>
    ...
    <figure class="wrapper wrapper-hero">
      <section id="hero" xyz="fade left-4 duration-8 stagger-1">
        <Animated><h1>Kaan Doğanay</h1></Animated>
    ...
    <figure class="wrapper wrapper-bg">
      <section id="about">
        <aside class="about" xyz="fade left-4 duration-8 stagger-0.5">
          ...
          <Animated
            ><p>
              I've been playing with web development since 2017. Over the years,
    ...
    <figure class="wrapper wrapper-bg">
      <section id="footer">
        ...
        <p>
          ...
          <a
            href="https://github.com/KFCarth/website"
            rel="noreferrer noopener"
            target="_blank"
            >GitHub</a
          >
